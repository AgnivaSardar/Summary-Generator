...
class SynopsisFactChecker:
    ...
    NON_RISK_SECTION_PATTERN = re.compile(
        r"^(PROBLEMS|IMPORTANT FINDINGS|TIMELINE|MEDICATION|ADVICE|PENDING TESTS):\s*(.*)$",
        re.IGNORECASE | re.MULTILINE
    )

    SECTION_PATTERN = re.compile(
        r"^(PROBLEMS|IMPORTANT FINDINGS|RISKS|TIMELINE|MEDICATION|ADVICE|PENDING TESTS):\s*(.*)$",
        re.IGNORECASE | re.MULTILINE
    )
